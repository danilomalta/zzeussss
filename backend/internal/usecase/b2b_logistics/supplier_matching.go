package b2b_logistics

import "titansystem-backend/internal/domain/entity"
...
type SupplierMatchingUseCase interface {
	...
	ProposeOrder(alert *entity.StockAlert) (string, error) // Retorna o ID da proposta criada
